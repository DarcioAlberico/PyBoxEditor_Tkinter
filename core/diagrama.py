...
# As estruturas moram em `core/diagrama_modelo.py` desde a ED-05 (sem `cv2`); os nomes
# continuam aqui para quem já os importava.
from core.diagrama_modelo import (  # noqa: E402,F401
    Casa, Leitura, Rotulos, Titulo, _plausivel)
